 ...
 *    Trigger selector is button-scoped: bare [class*="_7KE1Ra_trigger"] also
...
function installInteractions() {
  ...
  const TRIGGER_SEL = 'button[class*="_7KE1Ra_trigger"],button[class*="Sh0Q9G_trigger"],button[class*="JObwrW_trigger"]'
  const PANEL_SEL = '[class*="_7KE1Ra_menu"],[class*="mufS8W_card"],[class*="_3e4SsG_menu"]'
  const PANEL_ITEM_SEL = '[class~="_7KE1Ra_option"],[class~="_7KE1Ra_cell"],[class~="mufS8W_row"],[class~="_3e4SsG_item"]'
  const PRIM_MENU_SEL = '[class*="_list_19372"],[class*="_submenu_19372"]'
  const PRIM_ITEM_SEL = '[class*="_item_19372"]'
  const FLIP_SEL = '[class*="_7KE1Ra_menu"],[class*="mufS8W_card"],[class*="_3e4SsG_menu"]'
  const SCROLLFADE_SEL = '[class*="_7KE1Ra_groups"],[class*="mufS8W_viewport"],[class*="_3e4SsG_viewport"]'
  const CLIP_SEL = '[class*="_7KE1Ra_groups"],[class*="mufS8W_viewport"],[class*="_3e4SsG_viewport"],[class*="_scrollable_19372"] [class*="_viewport_19372"]'
  const CLIP_INNER_SEL = '[class*="_7KE1Ra_groups"],[class*="mufS8W_viewport"],[class*="_3e4SsG_viewport"]'
  const RISE_SEL = '[class~="_7KE1Ra_groupTitle"],[class~="_7KE1Ra_option"],[class~="_7KE1Ra_cell"]'
