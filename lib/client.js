...
var React = _react && _react.__esModule ? _react.default : _react;
...
function apply(ctx) {
  ...
  var COLORS = buildColorTokens();
  var KEEP = Object.assign({}, buildBaseTokens(), buildTypographyTokens());
  var FULL = Object.assign({}, COLORS, KEEP);
